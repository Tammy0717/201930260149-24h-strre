	...
	function checkForm(){
	 ...
	 function checkSecurityCode(){
		...
		if(checkcode == null || checkcode == ''){
			document.getElementById("spancheckcode").innerHTML="<font color='red'>验证码不能为空</font>";
			...
			xhr.onreadystatechange = function(){
				if(xhr.readyState == 4){
					if(xhr.status == 200){
						document.getElementById("spancheckcode").innerHTML = xhr.responseText;
		...
		// 3.打开连接
		xhr.open("GET","${pageContext.request.contextPath}/user_checkcode.action?time="+new Date().getTime()+"&checkcode="+checkcode,true);
		// 4.发送
		xhr.send(null);
					...
					<form id="registerForm" action="${ pageContext.request.contextPath }/user_regist.action"  method="post" novalidate="novalidate" onsubmit="return checkForm();">
						<table>
							...
							<tr>
								...
								<td>
									...
									<tr>
										...
										<td>
												<input type="text" id="name" name="name" class="text" maxlength="200" onblur="checkname()"/>
									...
									<tr>
										...
										<td>
												<input type="text" id="phone" name="phone" class="text" onblur="checkphone()" />
									...
									<tr>
										...
										<td>
												<input type="text" id="address" name="addr" class="text" maxlength="200" onblur="checkaddress()"/>
								...
								<tr>
									...
									<td>
										...
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" onblur="checkSecurityCode()" autocomplete="off" > <img id="checkImg" class="captchaImage" src="${pageContext.request.contextPath}/checkImg.action" onclick="change()" title="点击更换验证码">
										</span>
							...
							<tr>
								...
								<td>
									<button type="submit" id="sub" class="submit" value="同意以下协议并注册">同意以下协议并注册</button>
								</td>
							</tr>
							<tr>
								<th>&nbsp;
