...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			function view(){
				window.location.href = "${pageContext.request.contextPath}/bill_DisplayChart.action";
			}
		</script>
	</HEAD>
	<body>
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="17%">删除</td>
							...
							<s:iterator var="message" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="40%">
										<strong><font color="red"><s:property value="#message.message" /></font></strong>
									</td>
									
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="20%"><s:property value="#message.messagedate" />
										</span>
									</td>
									<td align="center" style="HEIGHT: 22px" width="20%">
												<a href="${ pageContext.request.contextPath }/message_delete.action?messageid=<s:property value="#message.messageid"/>">
