...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('0106','01','销售管理');
		d.add('010601','0106','销售管理','${pageContext.request.contextPath}/bill_findAll.action?page=1','','mainFrame');
		d.add('0107','01','留言管理');
		d.add('010701','0107','留言管理','${pageContext.request.contextPath}/message_findAll.action?page=1','','mainFrame');
		d.add('0108','01','注销退出');
